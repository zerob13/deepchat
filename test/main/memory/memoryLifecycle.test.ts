...
import { createFakeRepository, enabledConfig, makePresenter } from './support/memoryFakes'
import { deriveCanonicalStateFromLegacy } from '@/memory/domain/stateModel'
...
describe('MemoryService.getLifecycle', () => {
