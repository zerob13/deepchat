          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                <Icon v-else-if="isError" icon="lucide:alert-circle" class="w-4 h-4 text-destructive" />
                <Icon v-else icon="lucide:tool" class="w-4 h-4" />
              </button>
            </TooltipTrigger>
            <TooltipContent>
          ...
          <div v-else class="divide-y">
            <div v-for="tool in tools" :key="tool.function.name" class="p-3 hover:bg-accent">
              ...
              <div v-if="tool.function.parameters?.properties" class="mt-2">
                <div class="text-xs font-medium text-muted-foreground mb-1">{{ t('mcp.tools.parameters') }}:</div>
                <div class="space-y-1">
                  <div 
